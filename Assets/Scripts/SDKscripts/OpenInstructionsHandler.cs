...
namespace TiltFiveDemos
{
    ...
    {        
        ...
        public bool EnableInstructions { get => _enableInstructions; set => _enableInstructions = value; }
        ...
        public void LoadInstructions()
        {
            ...
            {
                _doublePressForInstructions = sceneSampleSettings.DoublePressForInstructions;
            }
            else // Set the default sample settings if we can't find the object in the scene.
            {
                _doublePressForInstructions = false;
            }
        }
